            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact-text">
                        <h2>Contact Info</h2>
                        <p>Pour vos reservations et renseignements, voici nos differents contacts et adresse:
                        </p>
                        <table>
                            <tbody>
                                <tr>
                                    <td class="c-o">Address:</td>
                                    <td>1 Av. Isiro, Gombe-KINSHASA, RDCongo</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Phone:</td>
                                    <td>(+243) 812 535 000</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Email:</td>
                                    <td>reservation@beatricehotel.com</td>
                                </tr>

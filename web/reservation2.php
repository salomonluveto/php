...
if(isset($_POST['b1'])){
    ...
    $k = "INSERT INTO chambre_reserve(nom,prix,photos,email) VALUES('chambre de luxe',198,'img/room/room-1.jpg','$em')";
    $req = "SELECT id FROM chambre_nonres";
      $a = $db->query($req);
      $ligne = $a->fetchAll();
  
if($db->query($k)){
 
        $res = "DELETE FROM chambre_nonres where id = 1";
        if($db->query($res)){
...
if(isset($_POST['b2'])){
    ...
    $db = new PDO("mysql:host=localhost;dbname=hotel","root","");
    $k = "INSERT INTO chambre_reserve(nom,prix,photos,email) VALUES('chambre de luxe avec litjumeaux',200,'img/room/room-2.jpg','$em')";
    $req = "SELECT id FROM chambre_nonres";
      $a = $db->query($req);
      $ligne = $a->fetchAll();
...
if($db->query($k)){
        ...
        $res = "DELETE FROM chambre_nonres where id = 2";
        if($db->query($res)){
    ...
    $db = new PDO("mysql:host=localhost;dbname=hotel","root","");
    $k = "INSERT INTO chambre_reserve(nom,prix,photos,email) VALUES('chambre standard',200,'img/room/room-3.jpg','$em')";
    $req = "SELECT id FROM chambre_nonres";
      $a = $db->query($req);
      $ligne = $a->fetchAll();
...
if($db->query($k)){
        ...
        $res = "DELETE FROM chambre_nonres where id = 3";
        if($db->query($res)){
...
if(isset($_POST['b4'])){
    ...
    $db = new PDO("mysql:host=localhost;dbname=hotel","root","");
    $k = "INSERT INTO chambre_reserve(nom,prix,photos,email) VALUES('luxury room',159,'img/room/room-4.jpg','$em')";
    $req = "SELECT id FROM chambre_nonres";
      $a = $db->query($req);
      $ligne = $a->fetchAll();
...
if($db->query($k)){
        ...
        $res = "DELETE FROM chambre_nonres where id = 4";
        if($db->query($res)){
...
if(isset($_POST['b5'])){
    ...
    $db = new PDO("mysql:host=localhost;dbname=hotel","root","");
    $k = "INSERT INTO chambre_reserve(nom,prix,photos,email) VALUES('King',174,'img/room/room-5.jpg','$em')";
    $req = "SELECT id FROM chambre_nonres";
      $a = $db->query($req);
      $ligne = $a->fetchAll();
...
if($db->query($k)){
        ...
        $res = "DELETE FROM chambre_nonres where id = 5";
        if($db->query($res)){
...
if(isset($_POST['b6'])){
    ...
    $db = new PDO("mysql:host=localhost;dbname=hotel","root","");
    $k = "INSERT INTO chambre_reserve(nom,prix,photos,email) VALUES('familly',250,'img/room/room-6.jpg','$em')";
    $req = "SELECT id FROM chambre_nonres";
      $a = $db->query($req);
      $ligne = $a->fetchAll();
...
if($db->query($k)){
        ...
        $res = "DELETE FROM chambre_nonres where id = 6";
        if($db->query($res)){

                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li><a href="form.php">Reservation</a>
            ...
            <div class="row">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Wifi, Television, petit-déjeuner inclus</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            <h4>Chambre deluxe avec lit jumeaux</h4>
                            <h3>200$<span>nuit</span></h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Taille:</td>
                        ...
                        <div class="ri-text">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="r-o">Services:</td>
                                        <td>Wifi, Television, Bathroom,petit-déjeuner inclus</td>
                                    </tr>
                                </tbody>
                            </table>
